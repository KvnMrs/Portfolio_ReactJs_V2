...
function Profile() {
  return (
    <>
      <div className=" w-auto h-modal-content flex flex-col bg-[url('https://t3.ftcdn.net/jpg/02/87/90/92/360_F_287909239_K8bMpb0M9oUyOI8zrdqpKPQnIlC73WfD.jpg')] bg-cover bg-no-repeat rounded-2xl">
